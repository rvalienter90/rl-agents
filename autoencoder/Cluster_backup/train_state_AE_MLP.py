...
def train(x_train, learning_rate, batch_size, epochs,latent_space_dim=16):
...
if __name__ == "__main__":
    ...
    deep_autoencoder,history = train(x_train, LEARNING_RATE, BATCH_SIZE, EPOCHS,latent_space_dim=latent_space_dim)
