...
from  train_state_AE import load_dataset_Grid, load_dataset_Image
...
if __name__ == "__main__":
    ...
    if image:
        Imagemodel = "newton/Autoencoder_CNN_Image_64_date-2021-10-02-16-11-55"
        # Imagemodel = "newton/Autoencoder_CNN_Image_32_date-2021-10-02-16-11-57"
        # Imagemodel = "model/AutoencoderCNN_Image_beginning"
        # Imagemodel = "newton/Autoencoder_CNN_Image_16_date-2021-10-02-16-11-57"
        autoencoder = Autoencoder.load(Imagemodel)
        x_train = load_dataset_Image(samples=100)
        ...
        plot_reconstructed_images(sample_obs, latent_representations.reshape(8,8,8))
