...
class Autoencoder:
    ...
    def __init__(self,
        ...
        self.decoder = None
        self.model = None
        self.timestamp =  "AutoencoderCNN_date-" + datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
    ...
    def train(self, x_train, batch_size, num_epochs):
        log_dir = os.path.join('logs','training',self.timestamp)
    ...
    def save(self, save_folder="."):
        ...
        save_folder = os.path.join(save_folder, self.timestamp)
...
class DeepAutoencoder:
    ...
    def __init__(self,
        ...
        self.decoder = None
        self.model = None
        self.timestamp =  "DeepAutoencoder_MLPdate-" + datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
